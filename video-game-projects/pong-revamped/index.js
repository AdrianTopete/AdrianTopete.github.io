(function(window, createjs, opspark, _) {
  ...
  //Question: What event is "handleLoadComplete" waiting for?
  function handleLoadComplete(event) {
    console.log('sounds loaded');
  }

  //Question: Why is this const formated like this (what is this type of notation called)?
  //Question: What does the "engine" const do?
  engine
